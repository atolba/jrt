	...
	*/
	...
	'connections' => [
		...
		'mysql' => [
			...
			'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'jrthompson')),
			'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'adminrWNWZ4l')),
			'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', 'w5xUl6slLzVU')),
			'charset'   => 'utf8',
